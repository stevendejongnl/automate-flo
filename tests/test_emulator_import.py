...
@pytest.mark.parametrize("fixture_name", [
    ...
    "atomic-add.flo",
    "atomic-clear-all.flo",
    "atomic-compare-and-store.flo",
    "atomic-load.flo",
    "atomic-store.flo",
    "attention-light.flo",
    "audio-device-connected.flo",
    "audio-device-recording.flo",
    "audio-player-control.flo",
    "audio-record-start.flo",
    "audio-record-stop.flo",
    "audio-stream-muted.flo",
    "audio-stream-set-mute.flo",
    "audio-volume.flo",
    "audio-volume-set.flo",
    "barcode-scan.flo",
    "battery-charging.flo",
    "battery-properties.flo",
    "bluetooth-device-active-set.flo",
    "bluetooth-device-bond-create.flo",
    "bluetooth-device-bond-remove.flo",
    "bluetooth-device-connect.flo",
    "bluetooth-device-disconnect.flo",
    "bluetooth-device-pick.flo",
    "bluetooth-device-scan.flo",
    "bluetooth-gatt-read.flo",
])
