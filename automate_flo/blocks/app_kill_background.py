...
class AppKillBackground(Action):
    """id 1008, UI name "Kill app background". Extends PackageAction extends Action -- one packageName field."""
    type_id = TYPE_ID
    ...
    def describe(self):
        return f"AppKillBackground(id={self.stmt_id}, package={self.package_name!r})"
