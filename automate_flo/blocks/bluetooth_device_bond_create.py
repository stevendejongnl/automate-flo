...
class BluetoothDeviceBondCreate(Decision):
    """id 1371, UI name "Create Bluetooth device bond". Extends Decision directly (no continuity field). Fields, in order: device_address, device_name (both wrap_str, like BluetoothDeviceConnected)."""
    type_id = TYPE_ID
    ...
    def describe(self):
        return f"BluetoothDeviceBondCreate(id={self.stmt_id})"
